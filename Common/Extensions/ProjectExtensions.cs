    ...
    public static class ProjectExtensions
    {
        ...
        public static bool IsDirty(this Project project)
        {
            ...
            if (project.ProjectItems != null &&
                project.ProjectItems.Cast<ProjectItem>().Any(x => x.ProjectItemIsDirty()))
            {
                return true;
            }
        ...
        public static Project[] Dependencies(BuildDependencies buildDependencies, Project[] allProjects,
            Project[] roots)
        {
